...
/* A string will be logged because we're using *string* interpolation, and another
data types are 'type-coerced' into the final string. */
...
var sideDish = "fries";
var subject = "I";
console.log(`${subject} ate ${mainDish} and ${sideDish}`);
