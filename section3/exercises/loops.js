...
// EXPLAIN: 0, 1, 2 are logged because i is just the 'counter' for this loop.
// Initially, i = 0, so that is logged, then i is incremented to 2, and that
// is logged. Then, i is incremeted to 3, which returns false on the condition,
// which in turn stops the loop.
